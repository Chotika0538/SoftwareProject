 ...
 * @author ASUS
 */
public class AddSouvenir extends javax.swing.JPanel implements CheckPanel{
    private ArrayList<SouvenirDetail> svdList;
     ...
     */
    public AddSouvenir(JPanel mainPanel) {
        svdList = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        pic_detailJP.setBackground(new java.awt.Color(204, 255, 153));
        ...
        svdList.add(new SouvenirDetail(svdList, pic_detailJP));
        pic_detailJP.add(svdList.get(0));
    ...
    private void addListBTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addListBTMouseClicked
        ...
        pic_detailJP.add(svdList.get(svdList.size()-1));
