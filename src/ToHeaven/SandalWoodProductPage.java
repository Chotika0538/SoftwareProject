...
public class SandalWoodProductPage extends javax.swing.JPanel {
    ...
    int i = 1;
    private SandalWooddao sandalwooddao;
    
    public SandalWoodProductPage(JPanel mainPanel) {
        sandalwooddao = new SandalWooddao();
         sandalwoodClassList = sandalwooddao.getAll();
         sandalwoodProduct = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        sandalwoodNameLB = new javax.swing.JLabel();
        ...
        jScrollPane1.setViewportView(sandalwoodProductPanel);
...
//    }
    public void showData(){
        for (SandalWood sandalwood : sandalwoodClassList){
            sandalwoodProduct.add(new SandalWoodProduct(sandalwood));
            if (sandalwoodClassList.size()>1){
                sandalwoodProductPanel.setPreferredSize(new Dimension(800, sandalwoodProductPanel.getHeight()+600));

            }
            sandalwoodProductPanel.add(sandalwoodProduct.getLast());
            sandalwoodProductPanel.revalidate();
            sandalwoodProductPanel.repaint();
        }
    }
    ...
    private javax.swing.JLabel sandalwoodNameLB;
    private javax.swing.JPanel sandalwoodProductPanel;
