 ...
 * @author ASUS
 */
public class SandalWoodProduct extends javax.swing.JPanel {
        private ArrayList<SandalWood> sddList;
        private SandalWood sandalwoodClass;
        public SandalWoodProduct(SandalWood sandalwood) {
            initComponents();
            getData(sandalwood);
    }
    /**
     ...
     */
        public void getData(SandalWood sandalwood){
        this.sandalwoodClass = sandalwood;
        name.setText(sandalwoodClass.toString());
        detailProduct.setText(sandalwoodClass.getDetail());
        productImage.setIcon(new ImageIcon(sandalwoodClass.getPath()));
        priceLB.setText(Double.toString(sandalwoodClass.getPrice()));
}

        public SandalWood getSandalWoodClass() {
        return sandalwoodClass;
    }
    /**
